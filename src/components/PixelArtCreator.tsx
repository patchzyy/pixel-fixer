            ...
            <div className="rounded-2xl border border-zinc-800 p-4 bg-zinc-900/40 overflow-hidden">
              ...
              {!isAdvancedCollapsed && (
                <div className="space-y-4 text-sm">
                  ...
                  <p className="text-[10px] leading-snug text-zinc-400">Use gamma and sharpen before quantization to enhance edges. A touch of grain helps hide banding on low palettes.</p>
                </div>
              )}
            </div>
            {/* Export panel */}
